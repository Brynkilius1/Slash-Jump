...
@onready var sword_action_lines_anim = $SwordPivot/Extended/Sword/SwordActionLinesAnim
...
@onready var swing_anim_timer = $SwordPivot/Extended/Sword/SwingAnimTimer
...
func _ready():
	...
	swing_anim_timer.connect("timeout", _on_swing_anim_animation_finished)
...
func SwingVFX():
	...
	sword_action_lines_anim.visible = true
	sword_action_lines_anim.flip_v = swing_dir + 1
	sword_action_lines_anim.play("default")
	indicator_pivot.visible = false
	swing_anim_timer.start()
...
func _on_swing_anim_animation_finished():
	...
	sword_action_lines_anim.visible = false
	knife_swing_anim.visible = false
	indicator_pivot.visible = true
...
func CheckIfSwordBehindPlayer():
	...
	print(sword_rotation_with_flip)
